...
from ._core import *  # type: ignore # noqa: F403
...
def Close(symbol, *, comment=..., ticket=...):  # type: ignore # -> bool | Literal['Partially'] | None:
    ...
def Buy(symbol, volume, price=..., *, comment=..., ticket=...):  # type: ignore # -> None:
    ...
def Sell(symbol, volume, price=..., *, comment=..., ticket=...):  # type: ignore # -> None:
    ...
